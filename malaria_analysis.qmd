...
This document provides a spatio-temporal analysis of malaria incidence in Ghana, including visualizations, statistical tests, and an interactive dashboard.

## Setup

Load the required libraries and set the working directory.
...
# Merge malaria data + intervention data
...
### Aggregating data by year and plot temporal trends.
